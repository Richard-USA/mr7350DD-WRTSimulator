...
<title>DD-WRT (build 65498) - Factory Defaults</title>
<script type="text/javascript">history.pushState({urlPath:'Factory_Defaults.asp'}, "DD-WRT (build 65498) - Factory Defaults", 'Factory_Defaults.asp')
</script><script type="text/javascript">
//<![CDATA[
function applycheck(F) {F.apply_button.value = sbutton.applied;}function to_apply(F) {if( F.FactoryDefaults[0].checked == 1 ) {if(!confirm(factdef.mess1)) {return false;}applycheck(F);applyupdate(F);return true;}}var update;addEvent(window, "load", function() {update = new StatusbarUpdate();update.start();});addEvent(window, "unload", function() {update.stop();});
//]]>
...
</div><div id="main"><div id="contents"><form name="default" action="http://192.168.1.1/apply.cgi" method="post"><input type="hidden" name="submit_button" value="Factory_Defaults" /><input type="hidden" name="action" value="Restore" /><input type="hidden" name="change_action" /><input type="hidden" name="submit_type" /><h2><script type="text/javascript">Capture(factdef.h2)</script></h2><fieldset><legend><script type="text/javascript">Capture(factdef.legend)</script></legend><div class="setting"><div class="label"><script type="text/javascript">Capture(factdef.restore)</script></div><input class="spaceradio" type="radio" name="FactoryDefaults" value="1" /><script type="text/javascript">Capture(share.yes)</script>&nbsp;<input class="spaceradio" type="radio" name="FactoryDefaults" value="0" checked="checked" /><script type="text/javascript">Capture(share.no)</script></div></fieldset><br/><div id="footer" class="submitFooter"><script type="text/javascript">
//<![CDATA[
document.write("<input title=\"" + sbutton.applytitle + "\" class=\"button green_btn\" type=\"button\" name=\"apply_button\" value=\"" + sbutton.apply + "\" onclick=\"to_apply(this.form);\" />");document.write("<input title=\"" + sbutton.canceltitle + "\" class=\"button brown_btn\" type=\"button\" name=\"reset_button\" value=\"" + sbutton.cancel + "\" onclick=\"window.location.reload();\" />");
//]]>
</script></div></form></div></div><div id="helpContainer"><div id="help"><h2><script type="text/javascript">Capture(share.help)</script></h2><dl><dd class="definition"><script type="text/javascript">Capture(hfactdef.right1)</script></dd></dl><br /><a href="javascript:openHelpWindow('HDefault.asp');"><script type="text/javascript">Capture(share.more)</script></a></div></div><div id="floatKiller"></div><div id="statusInfo"><div class="info"><script type="text/javascript">Capture(share.firmware)</script>:&nbsp;<script type="text/javascript">
//<![CDATA[
