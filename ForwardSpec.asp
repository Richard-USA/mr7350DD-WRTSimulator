...
<title>DD-WRT (build 65498) - Port Forwarding</title>
<script type="text/javascript">history.pushState({urlPath:'ForwardSpec.asp'}, "DD-WRT (build 65498) - Port Forwarding", 'ForwardSpec.asp')
</script><script type="text/javascript">
//<![CDATA[
function forward_add_submit(F) {F.change_action.value="gozila_cgi";F.submit_type.value = "add_forward_spec";apply(F);}function forward_del_submit(F,I) {F.change_action.value="gozila_cgi";F.del_value.value = I;F.submit_type.value = "del_forward_spec";apply(F);}function to_submit(F) {F.change_action.value = "";F.submit_type.value = "";F.save_button.value = sbutton.saving;apply(F);}function to_apply(F) {F.change_action.value = "";F.submit_type.value = "";F.apply_button.value = sbutton.applied;applytake(F);}var update;addEvent(window, "load", function() {stickControl(1);update = new StatusbarUpdate();update.start();});addEvent(window, "unload", function() {update.stop();});
//]]>
...
<path fill-rule="evenodd" d="M15.854 8.354a.5.5 0 0 0 0-.708l-3-3a.5.5 0 0 0-.708.708L14.293 7.5H5.5a.5.5 0 0 0 0 1h8.793l-2.147 2.146a.5.5 0 0 0 .708.708l3-3z"></path></svg></a><li><span><script type="text/javascript">Capture(bmenu.applicationspforwarding)</script></span></li>
