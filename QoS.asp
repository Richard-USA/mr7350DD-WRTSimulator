...
<title>DD-WRT (build 65498) - Quality of Service</title>
<script type="text/javascript">history.pushState({urlPath:'QoS.asp'}, "DD-WRT (build 65498) - Quality of Service", 'QoS.asp')
</script><script type="text/javascript">
//<![CDATA[
function svcs_grey(sw_disabled,F) {F.add_svc.disabled = sw_disabled;for (i=0; i<F.svqos_nosvcs.value; i++) {eval("F.svqos_svcprio" + i).disabled = sw_disabled;}}function pkts_grey(sw_disabled,F) {F.svqos_pktack.disabled = sw_disabled;F.svqos_pktsyn.disabled = sw_disabled;F.svqos_pktfin.disabled = sw_disabled;F.svqos_pktrst.disabled = sw_disabled;F.svqos_pkticmp.disabled = sw_disabled;}function macs_grey(sw_disabled,F,overwrite) {F.svqos_hwaddr0.disabled = sw_disabled;F.svqos_hwaddr1.disabled = sw_disabled;F.svqos_hwaddr2.disabled = sw_disabled;F.svqos_hwaddr3.disabled = sw_disabled;F.svqos_hwaddr4.disabled = sw_disabled;F.svqos_hwaddr5.disabled = sw_disabled;F.add_macprio_button.disabled = sw_disabled;if (sw_disabled == true) {for (i=0; i<F.svqos_nomacs.value; i++){eval("F.svqos_macup" + i).disabled = sw_disabled;eval("F.svqos_macdown" + i).disabled = sw_disabled;eval("F.svqos_maclanlvl" + i).disabled = sw_disabled;eval("F.svqos_macprio" + i).disabled = sw_disabled;}} else {for (i=0; i<F.svqos_nomacs.value; i++) {eval("F.svqos_macprio" + i).disabled = sw_disabled;if (eval("F.svqos_macup" + i))maclvl_grey(i, eval("F.svqos_macprio" + i), F, overwrite);}}}function maclvl_grey(num,field,F,overwrite) {if (overwrite) var sw_disabled = false;else var sw_disabled = (field.selectedIndex == 0) ? false : true;eval("F.svqos_macup" + num).disabled = sw_disabled;eval("F.svqos_macdown" + num).disabled = sw_disabled;eval("F.svqos_maclanlvl" + num).disabled = sw_disabled;}function port_grey(sw_disabled,F) {F.svqos_port1prio.disabled = sw_disabled;F.svqos_port2prio.disabled = sw_disabled;F.svqos_port3prio.disabled = sw_disabled;F.svqos_port4prio.disabled = sw_disabled;F.svqos_port1bw.disabled = sw_disabled;F.svqos_port2bw.disabled = sw_disabled;F.svqos_port3bw.disabled = sw_disabled;F.svqos_port4bw.disabled = sw_disabled;}function devs_grey(sw_disabled,F,overwrite) {F.svqos_dev.disabled = sw_disabled;F.add_devsprio_button.disabled = sw_disabled;if (sw_disabled == true) {for (i=0; i<F.svqos_nodevs.value; i++){eval("F.svqos_devup" + i).disabled = sw_disabled;eval("F.svqos_devdown" + i).disabled = sw_disabled;eval("F.svqos_devlanlvl" + i).disabled = sw_disabled;eval("F.svqos_devservice" + i).disabled = sw_disabled;eval("F.svqos_devprio" + i).disabled = sw_disabled;}} else {for (i=0; i<F.svqos_nodevs.value; i++) {eval("F.svqos_devprio" + i).disabled = sw_disabled;eval("F.svqos_devservice" + i).disabled = sw_disabled;if (eval("F.svqos_devup" + i))devlvl_grey(i, eval("F.svqos_devprio" + i), F, overwrite);}}}function devlvl_grey(num,field,F,overwrite) {if (overwrite) var sw_disabled = false;else var sw_disabled = (field.selectedIndex == 0) ? false : true;eval("F.svqos_devup" + num).disabled = sw_disabled;eval("F.svqos_devdown" + num).disabled = sw_disabled;eval("F.svqos_devlanlvl" + num).disabled = sw_disabled;}function ips_grey(sw_disabled,F,overwrite) {F.svqos_ipaddr0.disabled = sw_disabled;F.svqos_ipaddr1.disabled = sw_disabled;F.svqos_ipaddr2.disabled = sw_disabled;F.svqos_ipaddr3.disabled = sw_disabled;F.svqos_netmask.disabled = sw_disabled;F.add_ipsprio_button.disabled = sw_disabled;if (sw_disabled == true) {for (i=0; i<F.svqos_noips.value; i++){eval("F.svqos_ipup" + i).disabled = sw_disabled;eval("F.svqos_ipdown" + i).disabled = sw_disabled;eval("F.svqos_iplanlvl" + i).disabled = sw_disabled;eval("F.svqos_ipprio" + i).disabled = sw_disabled;}} else {for (i=0; i<F.svqos_noips.value; i++) {eval("F.svqos_ipprio" + i).disabled = sw_disabled;if (eval("F.svqos_ipup" + i))iplvl_grey(i, eval("F.svqos_ipprio" + i), F, overwrite);}}}function iplvl_grey(num,field,F,overwrite) {if (overwrite) var sw_disabled = false;else var sw_disabled = (field.selectedIndex == 0) ? false : true;eval("F.svqos_ipup" + num).disabled = sw_disabled;eval("F.svqos_ipdown" + num).disabled = sw_disabled;eval("F.svqos_iplanlvl" + num).disabled = sw_disabled;}function defaultlvl_grey(sw_disabled,F) {var sw_disabled = (sw_disabled == true) ? false : true;F.default_uplevel.disabled = sw_disabled;F.default_downlevel.disabled = sw_disabled;F.default_lanlevel.disabled = sw_disabled;}function qos_grey(num,F) {var sw_disabled = (num == F.wshaper_enable[1].value) ? true : false;F.wshaper_uplink.disabled = sw_disabled;F.wshaper_downlink.disabled = sw_disabled;F.wshaper_dev.disabled = sw_disabled;F.qos_type.disabled = sw_disabled;F.qos_aqd.disabled = sw_disabled;F.add_svc_button.disabled = sw_disabled;F.edit_svc_button.disabled = sw_disabled;/*port_grey(sw_disabled, F);*/pkts_grey(sw_disabled, F);devs_grey(sw_disabled, F, false);macs_grey(sw_disabled, F, false);ips_grey(sw_disabled, F, false);svcs_grey(sw_disabled, F);F.svqos_defaults.disabled = sw_disabled;if (sw_disabled == true) defaultlvl_grey(false, F);else if (F.svqos_defaults.checked) defaultlvl_grey(true, F);}function service(id, name, port_start, port_end, protocol, servicename) {this.id = id;this.name = name;this.start = port_start;this.end = port_end;this.servicename = servicename;}var sorton = function(x,y){if(x.name <  y.name) {return -1;} else {if (x.name == y.name) {return 0;} else {return 1;}}};services=new Array();services_length=0;services[0]=new service(0, "1kxun", 0, 0, 101, "dpi");
...
services_length = 532;
services.sort(sorton);function svc_add_submit(F) {F.change_action.value="gozila_cgi";F.submit_type.value = "add_svc";apply(F);}function ip_add_submit(F) {F.change_action.value="gozila_cgi";F.submit_type.value = "add_ip";apply(F);}function dev_add_submit(F) {F.change_action.value="gozila_cgi";F.submit_type.value = "add_dev";apply(F);}function mac_add_submit(F) {F.change_action.value="gozila_cgi";F.submit_type.value = "add_mac";apply(F);}function submitcheck(F) {devs_grey(false, F, true);ips_grey(false, F, true);macs_grey(false, F, true);if (F.default_uplevel) {F.default_uplevel.disabled = false;F.default_downlevel.disabled = false;F.default_lanlevel.disabled = false;}F.change_action.value="gozila_cgi";F.submit_type.value = "save";}function qosmacs_del_submit(F,I) {F.change_action.value="gozila_cgi";F.del_value.value = I;F.submit_type.value = "del_qosmacs";apply(F);}function qosips_del_submit(F,I) {F.change_action.value="gozila_cgi";F.del_value.value = I;F.submit_type.value = "del_qosips";apply(F);}function qosdevs_del_submit(F,I) {F.change_action.value="gozila_cgi";F.del_value.value = I;F.submit_type.value = "del_qosdevs";apply(F);}function qossvcs_del_submit(F,I) {F.change_action.value="gozila_cgi";F.del_value.value = I;F.submit_type.value = "del_qossvcs";apply(F);}function to_submit(F) {submitcheck(F);F.save_button.value = sbutton.saving;apply(F);}function to_apply(F) {submitcheck(F);F.apply_button.value = sbutton.applied;applytake(F);}var update;addEvent(window, "load", function() {stickControl(1);qos_grey(0,document.QoS);update = new StatusbarUpdate();update.start();});addEvent(window, "unload", function() {update.stop();});
//]]>
...
<path fill-rule="evenodd" d="M15.854 8.354a.5.5 0 0 0 0-.708l-3-3a.5.5 0 0 0-.708.708L14.293 7.5H5.5a.5.5 0 0 0 0 1h8.793l-2.147 2.146a.5.5 0 0 0 .708.708l3-3z"></path></svg></a><li><a href="ForwardSpec.asp"><script type="text/javascript">Capture(bmenu.applicationspforwarding)</script></a></li>
<li><a href="Forward.asp"><script type="text/javascript">Capture(bmenu.applicationsprforwarding)</script></a></li>
<li><a href="ForwardIP.asp"><script type="text/javascript">Capture(bmenu.applicationsipforwarding)</script></a></li>
...
</div><div id="main"><div id="contents"><form name="QoS" action="http://192.168.1.1/apply.cgi" method="post" ><input type="hidden" name="submit_button" value="QoS" /><input type="hidden" name="action" value="Apply" /><input type="hidden" name="change_action" /><input type="hidden" name="submit_type" /><input type="hidden" name="del_value" /><input type="hidden" name="commit" value="1" /><h2><script type="text/javascript">Capture(qos.h2)</script></h2><fieldset><legend><script type="text/javascript">Capture(qos.legend)</script></legend><div class="setting"><div class="label"><script type="text/javascript">Capture(qos.srv)</script></div><input class="spaceradio" type="radio" value="1" name="wshaper_enable" onclick="qos_grey(this.value,this.form)"  /><script type="text/javascript">Capture(share.enable)</script>&nbsp;<input class="spaceradio" type="radio" value="0" name="wshaper_enable" onclick="qos_grey(this.value,this.form)" checked /><script type="text/javascript">Capture(share.disable)</script></div><div class="setting"><div class="label"><script type="text/javascript">Capture(share.port)</script></div><select name="wshaper_dev"><option value="WAN" selected>WAN</option><option value="LAN" >LAN &amp; WLAN</option></select></div><div class="setting"><div class="label"><script type="text/javascript">Capture(qos.type)</script></div><select name="qos_type"><option value="0" selected>HTB</option><option value="1" >HFSC</option></select></div><input type="hidden" name="qos_aqd" </input><div class="setting"><div class="label"><script type="text/javascript">Capture(qos.dnlink)</script></div><input class="num" type="number" size="10" min="0" max="1000000" step="10" name="wshaper_downlink" value="0" />&nbsp;<script type="text/javascript">Capture(qos.speed)</script></div><div class="setting"><div class="label"><script type="text/javascript">Capture(qos.uplink)</script></div><input class="num" type="number" size="10" min="100" max="1000000" step="10" name="wshaper_uplink" value="0" />&nbsp;<script type="text/javascript">Capture(qos.speed)</script></div></fieldset><br /><fieldset><legend><script type="text/javascript">Capture(qos.legend7)</script></legend><table class="table" summary="packet-type priority table"><tbody><tr><td colspan="5"><script type="text/javascript">Capture(qos.pktdesc)</script></td></tr><tr class="center">
<td><input type="checkbox" name="svqos_pktack" value="ACK" ><script type="text/javascript">Capture(qos.pktack)</script></input></td>
<td><input type="checkbox" name="svqos_pktsyn" value="SYN" ><script type="text/javascript">Capture(qos.pktsyn)</script></input></td>
<td><input type="checkbox" name="svqos_pktfin" value="FIN" ><script type="text/javascript">Capture(qos.pktfin)</script></input></td>
<td><input type="checkbox" name="svqos_pktrst" value="RST" ><script type="text/javascript">Capture(qos.pktrst)</script></input></td>
<td><input type="checkbox" name="svqos_pkticmp" value="ICMP" ><script type="text/javascript">Capture(qos.pkticmp)</script></input></td>
</tr>
</tbody></table></fieldset><br /><fieldset><legend><script type="text/javascript">Capture(qos.legend2)</script></legend><table class="table" summary="services priority table"><thead><tr><th><script type="text/javascript">Capture(share.srv)</script></th><th><script type="text/javascript">Capture(share.priority)</script></th><th width="12%"><script type="text/javascript">Capture(share.packets)</script></th><th class="center" width="10%"><script type="text/javascript">Capture(share.actiontbl)</script></th></tr></thead><tbody><tr><td colspan="4"><input type="hidden" name="svqos_nosvcs" value="0" /></td></tr><tr><td><select name="add_svc"><script type="text/javascript">
//<![CDATA[
var i=0;for(i=0;i<services_length;i++) {if (services[i].servicename == "udp" || services[i].servicename == "tcp" || services[i].servicename == "both") {document.write("<option value=\""+services[i].name+"\">"+services[i].name+ " [ "+services[i].start+" ~ "+services[i].end + " ]" + "</option>");}else{document.write("<option value=\""+services[i].name+"\">"+services[i].name+ " [ "+services[i].servicename+ " ]" +  "</option>");}}
//]]>
</script></select></td><td colspan="2">&nbsp;</td><td class="center"><script type="text/javascript">
//<![CDATA[
document.write("<input class=\"add\" type=\"button\" name=\"add_svc_button\" arial-label=\"" + sbutton.add + "\" onclick=\"svc_add_submit(this.form);\" />");
//]]>
</script></td></tr></tbody></table><br /><div class="center"><script type="text/javascript">
//<![CDATA[
...
//]]>
</script></div></fieldset><br /><fieldset><legend><script type="text/javascript">Capture(qos.legend8)</script></legend><table class="table" summary="ifname priority table"><thead><tr>
...
<tr><td colspan="3"><input type="hidden" name="svqos_nodevs" value="0" /></td></tr><tr><td><select name="svqos_dev"><option value="br0">LAN &amp; WLAN</option>
</select></td><td colspan="5">&nbsp;</td><td class="center"><script type="text/javascript">
//<![CDATA[
...
//]]>
</script></td></tr></table></fieldset><br /><fieldset><legend><script type="text/javascript">Capture(qos.legend3)</script></legend><table class="table" summary="IP addresses priority table"><thead><tr>
...
//]]>
</script></td></tr></tbody></table></fieldset><br /><fieldset><legend><script type="text/javascript">Capture(qos.legend4)</script></legend><table class="table" summary="MAC priority table"><thead><tr>
...
<input type="hidden" name="svqos_nomacs" value="0" /><tr><td><input name="svqos_hwaddr0" value="00" size="2" maxlength="2" onblur="valid_mac(this,0)" class="num" />:<input name="svqos_hwaddr1" value="00" size="2" maxlength="2" onblur="valid_mac(this,1)" class="num" />:<input name="svqos_hwaddr2" value="00" size="2" maxlength="2" onblur="valid_mac(this,1)" class="num"/>:<input name="svqos_hwaddr3" value="00" size="2" maxlength="2" onblur="valid_mac(this,1)" class="num" />:<input name="svqos_hwaddr4" value="00" size="2" maxlength="2" onblur="valid_mac(this,1)" class="num" />:<input name="svqos_hwaddr5" value="00" size="2" maxlength="2" onblur="valid_mac(this,1)" class="num" /></td><td colspan="4">&nbsp;</td><td class="center"><script type="text/javascript">
//<![CDATA[
...
//]]>
</script></td></tr></tbody></table></fieldset><br /><fieldset>
<legend><script type="text/javascript">Capture(qos.legend6)</script></legend><div class="setting">
<div class="label"><script type="text/javascript">Capture(qos.enabledefaultlvls)</script></div>
<input type="checkbox" onclick="defaultlvl_grey(this.checked,this.form)" name="svqos_defaults" value="1"  />
</div>
<div class="setting">
<div class="label">WAN <script type="text/javascript">document.write(qos.bandwidth)</script></div>
<input class"num" type="number" size="10" name="default_downlevel" value="100000" disabled/>
&nbsp<script type="text/javascript">document.write(qos.speed+" "+qos.down)</script></div>
<div class="setting">
<div class="label">WAN <script type="text/javascript">document.write(qos.bandwidth)</script></div>
<input class"num" type="number" size="10" name="default_uplevel" value="100000" disabled/>
...
<input class"num" type="number" size="10" name="default_lanlevel" value="100000" disabled/>
&nbsp<script type="text/javascript">document.write(qos.speed)</script></div>
</fieldset><br />
<!--<fieldset><legend><script type="text/javascript">Capture(qos.legend5)</script></legend><table class="table"><thead><tr><th>&nbsp;</th><th><script type="text/javascript">Capture(share.priority)</script></th><th><script type="text/javascript">Capture(qos.maxrate_o)</script></th></tr></thead><tbody><tr><td><script type="text/javascript">Capture(share.port)</script> 1</td><td><select name="svqos_port1prio"><script type="text/javascript">
//<![CDATA[
document.write("<option value=\"100\"  >" + qos.prio_x + "</option>");document.write("<option value=\"10\" selected >" + qos.prio_p + "</option>");document.write("<option value=\"20\"  >" + qos.prio_e + "</option>");document.write("<option value=\"30\"  >" + share.standard + "</option>");document.write("<option value=\"40\"  >" + qos.prio_b + "</option>");
//]]>
</script></select></td><td><select name="svqos_port1bw"><script type="text/javascript">
//<![CDATA[
document.write("<option value=\"0\"  >" + share.disable + "</option>");
//]]>
</script><option value="256K" >256k</option><option value="512K" >512k</option><option value="1M" >1M</option><option value="2M" >2M</option><option value="5M" >5M</option><option value="10M" >10M</option><option value="20M" >20M</option><option value="50M" >50M</option><option value="FULL" selected>100M</option></select></td></tr><tr><td><script type="text/javascript">Capture(share.port)</script> 2</td><td><select name="svqos_port2prio"><script type="text/javascript">
//<![CDATA[
document.write("<option value=\"100\"  >" + qos.prio_x + "</option>");document.write("<option value=\"10\" selected >" + qos.prio_p + "</option>");document.write("<option value=\"20\"  >" + qos.prio_e + "</option>");document.write("<option value=\"30\"  >" + share.standard + "</option>");document.write("<option value=\"40\"  >" + qos.prio_b + "</option>");
//]]>
</script></select></td><td><select name="svqos_port2bw"><script type="text/javascript">
//<![CDATA[
document.write("<option value=\"0\"  >" + share.disable + "</option>");
//]]>
</script><option value="256K" >256k</option><option value="512K" >512k</option><option value="1M" >1M</option><option value="2M" >2M</option><option value="5M" >5M</option><option value="10M" >10M</option><option value="20M" >20M</option><option value="50M" >50M</option><option value="FULL" selected>100M</option></select></td></tr><tr><td><script type="text/javascript">Capture(share.port)</script> 3</td><td><select name="svqos_port3prio"><script type="text/javascript">
//<![CDATA[
document.write("<option value=\"100\"  >" + qos.prio_x + "</option>");document.write("<option value=\"10\" selected >" + qos.prio_p + "</option>");document.write("<option value=\"20\"  >" + qos.prio_e + "</option>");document.write("<option value=\"30\"  >" + share.standard + "</option>");document.write("<option value=\"40\"  >" + qos.prio_b + "</option>");
//]]>
</script></select></td><td><select name="svqos_port3bw"><script type="text/javascript">
//<![CDATA[
document.write("<option value=\"0\"  >" + share.disable + "</option>");
//]]>
</script><option value="256K" >256k</option><option value="512K" >512k</option><option value="1M" >1M</option><option value="2M" >2M</option><option value="5M" >5M</option><option value="10M" >10M</option><option value="20M" >20M</option><option value="50M" >50M</option><option value="FULL" selected>100M</option></select></td></tr><tr><td><script type="text/javascript">Capture(share.port)</script> 4</td><td><select name="svqos_port4prio"><script type="text/javascript">
//<![CDATA[
document.write("<option value=\"100\"  >" + qos.prio_x + "</option>");document.write("<option value=\"10\" selected >" + qos.prio_p + "</option>");document.write("<option value=\"20\"  >" + qos.prio_e + "</option>");document.write("<option value=\"30\"  >" + share.standard + "</option>");document.write("<option value=\"40\"  >" + qos.prio_b + "</option>");
//]]>
</script></select></td><td><select name="svqos_port4bw"><script type="text/javascript">
//<![CDATA[
document.write("<option value=\"0\"  >" + share.disable + "</option>");
//]]>
</script><option value="256K" >256k</option><option value="512K" >512k</option><option value="1M" >1M</option><option value="2M" >2M</option><option value="5M" >5M</option><option value="10M" >10M</option><option value="20M" >20M</option><option value="50M" >50M</option><option value="FULL" selected>100M</option></select></td></tr></tbody></table></fieldset><br />--><div id="footer" class="submitFooter"><script type="text/javascript">
//<![CDATA[
submitFooterButton(1,1);
//]]>
</script></div></form></div></div><div id="helpContainer"><div id="help"><h2><script type="text/javascript">Capture(share.help)</script></h2><dl><dt class="term"><script type="text/javascript">Capture(qos.legend)</script></dt><dd class="definition"><script type="text/javascript">Capture(hqos.right2)</script></dd><dt class="term"><script type="text/javascript">Capture(qos.legend2)</script>:</dt><dd class="definition"><script type="text/javascript">Capture(hqos.right6)</script></dd><dt class="term"><script type="text/javascript">Capture(qos.legend3)</script>:</dt><dd class="definition"><script type="text/javascript">Capture(hqos.right8)</script></dd><dt class="term"><script type="text/javascript">Capture(qos.legend4)</script>:</dt><dd class="definition"><script type="text/javascript">Capture(hqos.right10)</script></dd><dt class="term"><script type="text/javascript">Capture(qos.legend6)</script></dt><dd class="definition"><script type="text/javascript">Capture(hqos.right4)</script></dd><!--dt class="term"><script type="text/javascript">Capture(qos.legend5)</script>:</dt><dd class="definition"><script type="text/javascript">Capture(hqos.right12)</script></dd--></dl><br/><a href="javascript:openHelpWindow('HQos.asp');"><script type="text/javascript">Capture(share.more)</script></a></div></div><div id="floatKiller"></div><div id="statusInfo"><div class="info"><script type="text/javascript">Capture(share.firmware)</script>:&nbsp;<script type="text/javascript">
//<![CDATA[
